            ...
            <li>
              ...
              <ul>
                <li>
                  ...
                  предпринимаемые ООО «М-ТЭК» (ИНН: 7451417625, ОГРН:
                  1177456003361) (далее — Оператор).
                </li>
                <li>
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  ...
                  выгодоприобретелем или поручителем, по которому является
            ...
            <li>
              ...
              <ul>
                <li>
                  ...
                  <ul>
                    <li>
                      информирование Пользователя о товарах, услугах,
                      деятельности Оператора посредством отправки электронных
                      писем, звонков, отправки сообщений в мессенджеры;
                    </li>
                    <li>реализация Пользователю товаров и услуг Оператора;</li>
                    <li>
                      предоставление доступа Пользователю к сервисам, информации
                      и/или материалам, содержащимся на веб-сайте;
                    </li>
                    <li>
                      аналитика поведения пользователей на сайте, улучшение
                      сервиса и контента;
                    </li>
                    <li>
                ...
                <li>
                  ...
                  <ul>
                    ...
                    <li>
                      адрес (город, улица, дом, квартира, подъезд, этаж, код
                      домофона);
                    </li>
                    <li>cookie, IP-адреса.</li>
                  </ul>
                </li>
                <li>
                ...
                <li>
                  ...
                  <ul>
                    <li>
                      Сбор, запись, систематизация, накопление, уничтожение и
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  ...
                  договора, стороной которого либо выгодоприобретелем или
                  ...
                  персональных данных будет являться выгодоприобретелем или
                  поручителем.
                </li>
                <li>
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  ...
                  Оператора m-tek74@yandex.ru с пометкой «Актуализация
                  персональных данных».
                </li>
                <li>
                ...
                <li>
                  ...
                  m-tek74@yandex.ru с пометкой «Отзыв согласия на обработку
                  персональных данных».
                </li>
                <li>
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  ...
                  >
                    <UiLink color="primary_dark" variant="body2">
                      https://мтэк.рф/Политика_конфиденциальности/
                    </UiLink>
                  </Link>
                  .
                </li>
